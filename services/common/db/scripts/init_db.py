...
def main(schema_file: Path, expected_tables: Set[str]) -> None:
    """
    Main initialization function.
    
    Args:
        schema_file: Path to the SQL schema file
        expected_tables: Set of table names that should exist after initialization
    """
    print("=" * 60)
    ...
    if not initialize_schema(host, port, user, password, dbname, schema_file, expected_tables):
